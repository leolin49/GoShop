...
type OrderServiceClient interface {
	PlaceOrder(ctx context.Context, in *ReqPlaceOrder, opts ...grpc.CallOption) (*RspPlaceOrder, error)
	ListOrder(ctx context.Context, in *ReqListOrder, opts ...grpc.CallOption) (*RspListOrder, error)
	MarkOrderPaid(ctx context.Context, in *ReqMarkOrderPaid, opts ...grpc.CallOption) (*RspMarkOrderPaid, error)
}
...
func (c *orderServiceClient) PlaceOrder(ctx context.Context, in *ReqPlaceOrder, opts ...grpc.CallOption) (*RspPlaceOrder, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RspPlaceOrder)
...
func (c *orderServiceClient) ListOrder(ctx context.Context, in *ReqListOrder, opts ...grpc.CallOption) (*RspListOrder, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RspListOrder)
...
func (c *orderServiceClient) MarkOrderPaid(ctx context.Context, in *ReqMarkOrderPaid, opts ...grpc.CallOption) (*RspMarkOrderPaid, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RspMarkOrderPaid)
...
type OrderServiceServer interface {
	PlaceOrder(context.Context, *ReqPlaceOrder) (*RspPlaceOrder, error)
	ListOrder(context.Context, *ReqListOrder) (*RspListOrder, error)
	MarkOrderPaid(context.Context, *ReqMarkOrderPaid) (*RspMarkOrderPaid, error)
...
func (UnimplementedOrderServiceServer) PlaceOrder(context.Context, *ReqPlaceOrder) (*RspPlaceOrder, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PlaceOrder not implemented")
}
func (UnimplementedOrderServiceServer) ListOrder(context.Context, *ReqListOrder) (*RspListOrder, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListOrder not implemented")
}
func (UnimplementedOrderServiceServer) MarkOrderPaid(context.Context, *ReqMarkOrderPaid) (*RspMarkOrderPaid, error) {
...
func _OrderService_PlaceOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).PlaceOrder(ctx, req.(*ReqPlaceOrder))
	}
...
func _OrderService_ListOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).ListOrder(ctx, req.(*ReqListOrder))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OrderService_MarkOrderPaid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).MarkOrderPaid(ctx, req.(*ReqMarkOrderPaid))
	}
	return interceptor(ctx, in, info, handler)
}
